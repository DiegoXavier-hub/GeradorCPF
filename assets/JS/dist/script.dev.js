...
function GerarCPF() {
  var a1, a2, a3, a4, a5, a6, a7, a8, a9, d1, d2, cpfp;
  ...
  var d1p = a1 * 10 + a2 * 9 + a3 * 8 + a4 * 7 + a5 * 6 + a6 * 5 + a7 * 4 + a8 * 3 + a9 * 2;
  d1p % 11 < 2 ? d1 = 0 : d1 = 11 - d1p % 11;
  var d2p = a1 * 11 + a2 * 10 + a3 * 9 + a4 * 8 + a5 * 7 + a6 * 6 + a7 * 5 + a8 * 4 + a9 * 3 + d1 * 2;
...
function ValidarCPF() {
  var cpf = document.getElementById('cpf-Validate').value.replace(/[^0-9]/g, '');
  document.getElementById('cpf-Validate').value = '';
  var a1, a2, a3, a4, a5, a6, a7, a8, a9, d1, d2, d1v, d2v;
  a1 = cpf.substr(0, 1);
  a2 = cpf.substr(1, 1);
  a3 = cpf.substr(2, 1);
  a4 = cpf.substr(3, 1);
